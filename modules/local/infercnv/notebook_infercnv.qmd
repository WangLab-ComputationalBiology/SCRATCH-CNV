...
params:
  ...
  reference_cells: "data/reference_cells.csv"
  input_model: "human"
...
reference_cells <- params$reference_cells
...
reference_cells <- readr::read_csv(reference_cells)
...
infercnv_object <- infercnv::CreateInfercnvObject(
  raw_counts_matrix = seurat_counts,
          annotations_file = reference_cells,
          delim = "\t",
